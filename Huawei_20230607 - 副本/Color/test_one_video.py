...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--videopath",
        type=str,
        default="/mnt/sdb/cyq_data/Data/YoutubeVQA/TestVideo/Animation_360P-3e40_crf_10_ss_00_t_20.0.mp4",
    ...
    views, _ = spatial_temporal_view_decomposition(
        args.videopath, dopt["sample_types"], temporal_samplers
    )
    ...
    print("{} : {}".format(args.videopath,fuse_results(results)))
    # if args.fusion:
    ...
    #     rescale_results(results, vname=args.videopath)
