...
imgs_path = 'D:/second_semester/cross_dataset/llv_720_imgs'
save_folder = 'D:/second_semester/LLE-VQA/swin_transformer/llv_brightness_consistency'
...
for imgs in os.listdir(imgs_path):
    ...
    for img in os.listdir(img_path):
        ...
        read_frame = read_frame.convert('L')  #转gray
