...
def main(config):
    ...
    folder_path = {
        ...
        'SPAQ': '/DATA/gaoyixuan_data/imagehist/SPAQ/',
        'VCLFER': '/DATA/gaoyixuan_data/imagehist/VCLFER/',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', dest='dataset', type=str, default='SPAQ', help='Support datasets: livec|koniq-10k|LIVEMD|live|csiq|tid2013|cid')
    ...
    parser.add_argument('--test_patch_num', dest='test_patch_num', type=int, default=5, help='Number of sample patches from testing image')
...
# 
# hyperiqa-VCLFER
# [[1.         1.         0.82857143 0.82857143 0.94285714 0.77142857
#   0.94285714 0.37142857 0.94285714 0.94285714]]
# average MOSsrcc:0.8571
# [[0.92599155 0.89353733 0.65723251 0.63467118 0.82120202 0.66771545
#   0.79885252 0.27754166 0.68843778 0.63667378]]
# average MOSplcc:0.7002
# [[ 7.19292905  3.44951148 11.92802514 10.08148157  6.23046977  3.91010322
#    7.5280343   5.06559737 13.48385475  7.43792737]]
# average MOSrmse:7.6308
